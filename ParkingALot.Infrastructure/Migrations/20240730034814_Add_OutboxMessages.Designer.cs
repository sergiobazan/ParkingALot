...
namespace ParkingALot.Infrastructure.Migrations
{
    ...
    [Migration("20240730034814_Add_OutboxMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkingALot.Domain.ParkingLotOwners.ParkingLot", b =>
                {
                    ...
                    b.Property<TimeOnly>("CloseAtUtc")
            ...
            modelBuilder.Entity("ParkingALot.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTime>("OcurredAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("ocurred_at_utc");

                    b.Property<DateTime?>("ProcessAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("process_at_utc");
            ...
            modelBuilder.Entity("ParkingALot.Domain.ParkingLotOwners.ParkingLot", b =>
                {
                    b.HasOne("ParkingALot.Domain.ParkingLotOwners.ParkingLotOwner", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_parking_lots_parking_lot_owners_parking_lot_owner_id");
